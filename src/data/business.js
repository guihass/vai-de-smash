...
export const siteUrl = (env.VITE_SITE_URL || "https://brasaburger.com.br").replace(/\/$/, "");
...
export const business = {
  ...
  instagramUrl: env.VITE_INSTAGRAM_URL || "https://instagram.com/brasaburger",
  menuUrl: env.VITE_MENU_URL || "https://app.cardapioweb.com/brasaburger",
  rating: 4.8,
  soldCount: "+ de 60 mil",
};
